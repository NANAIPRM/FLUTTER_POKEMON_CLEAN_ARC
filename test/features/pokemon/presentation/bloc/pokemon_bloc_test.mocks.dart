...
// in flutter_pokemon_clean_arc/test/features/pokemon/presentation/bloc/pokemon_bloc_test.dart.
...
import 'package:flutter_pokemon_clean_arc/core/error/failures.dart' as _i6;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetPokemonList extends _i1.Mock implements _i9.GetPokemonList {
  @override
  _i2.PokemonRepository get repository => (super.noSuchMethod(
        Invocation.getter(#repository),
        returnValue: _FakePokemonRepository_0(
  ...
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Pokemon>>> call(
          _i9.GetPokemonListParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
