...
// in flutter_pokemon_clean_arc/test/features/pokemon/domain/repositories/pokemon_repository_test.dart.
...
import 'package:flutter_pokemon_clean_arc/core/error/failures.dart' as _i5;
...
class MockPokemonRepository extends _i1.Mock implements _i3.PokemonRepository {
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Pokemon>> getPokemon(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPokemon,
          [id],
